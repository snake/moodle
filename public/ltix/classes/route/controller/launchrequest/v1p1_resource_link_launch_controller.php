...
/**
 * Controller handling LTI v1p1 Resource Link Request launches.
 *
 * @package    core_ltix
 * @copyright  2026 Jake Dallimore <jrhdallimore@gmail.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class v1p1_resource_link_launch_controller {

    /**
     * Ctor.
     *
     * @param v1p1_resource_link_launch_service $launchservice
     * @param launch_data_repository $launchdatarepository
     */
    public function __construct(
        protected v1p1_resource_link_launch_service $launchservice,
        protected launch_data_repository $launchdatarepository,
    ) {
    }

    /**
     * Handler for the v1p1 resource link request launch route.
     *
     ...
     */
    #[route(
        // Resolves to https://SITE/ltix/v1p1/resourcelink/10/launch
        path: '/v1p1/resourcelink/{resourcelinkid}/launch',
        method: ['GET', 'POST'],
