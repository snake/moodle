...
namespace core_ltix\local\lticore\message\launchrequest\service\v1p1;
...
/**
 * Application service which builds a v1p1 resource link request message.
 *
 * @package    core_ltix
 * @copyright  2026 Jake Dallimore <jrhdallimore@gmail.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class v1p1_resource_link_launch_service {

    /**
     * Ctor.
     *
     * @param parameters_builder_factory $pipelinefactory
     * @param v1p1_resource_link_launch_request_builder $requestbuilder
    ...
    public function __construct(
        ...
        private v1p1_resource_link_launch_request_builder $requestbuilder,
    ...
    public function launch(
        ...
        $optionalparamspipeline = $this->pipelinefactory->create_for(lti_version::LTI_VERSION_1, $messagetype);
