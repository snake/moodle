...
function xmldb_main_upgrade($oldversion) {
    ...
    if ($oldversion < 2025071800.01) {
        ...
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2025071800.01);
    }

    if ($oldversion < 2025071800.02) {
        ...
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2025071800.02);
    }

    if ($oldversion < 2025071800.04) {
        ...
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2025071800.04);
    }
