...
$string['noplacements_message'] = 'Placements can be configured in the tool\'s configuration.';
$string['noplacements_title'] = 'There are no available placements for this tool';
