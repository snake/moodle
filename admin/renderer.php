    ...
    public function plugins_control_panel(core_plugin_manager $pluginman, array $options = array()) {
        ...
        foreach ($plugininfo as $type => $plugins) {
            ...
            foreach ($plugins as $name => $plugin) {
                ...
                $deprecatedmsg = '';
                // TODO need this to be aware of installed vs not installed. Only report status for INSTALLED plugins.
                //  Non-installed deprecated plugin types should be skipped further up above....
                if ($plugin->is_deprecated()) {
