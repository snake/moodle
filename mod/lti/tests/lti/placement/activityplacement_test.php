...
final class activityplacement_test extends \advanced_testcase {
    ...
    public function test_get_instance(): void {
        $instance = \core_ltix\local\placement\placements_helper::get_deeplinking_placement_instance('mod_lti:activityplacement');
        $this->assertInstanceOf(\core_ltix\local\placement\deeplinking_placement_handler::class, $instance);
    }
}
