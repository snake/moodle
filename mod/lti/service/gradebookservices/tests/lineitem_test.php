...
class lineitem_test extends \advanced_testcase {
    ...
    public function test_sequential_score_posts(): void {
        ...
        // Read the results via the service. This should also return the incorrect dategraded time (timemodified in LTI terms).
        ...
        $this->assertGreaterThanOrEqual(strtotime($score->timestamp), strtotime($result->timestamp));
