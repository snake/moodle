...
class external_api_test extends \advanced_testcase {
    ...
    /**
     * Test verifying external API for a deprecated/deleted plugin types.
     *
     * @runInSeparateProcess
     * @return void
     */
    public function test_external_api_deprecated_plugintype(): void {
        ...
        $this->assertNotFalse(\core_external\external_api::external_function_info('fake_fullfeatured_service_test', IGNORE_MISSING));
