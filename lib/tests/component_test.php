...
final class component_test extends \advanced_testcase {
    ...
    public function test_core_component_deprecated_plugintype(): void {
        ...
        $this->assertFalse(component::is_deprecated_plugin('fake_fullfeatured'));
        $this->assertFalse(component::is_deleted_plugin_type('fake'));
        $this->assertFalse(component::is_deleted_plugin('fake_fullfeatured'));
        ...
        $this->assertTrue(component::is_deprecated_plugin('fake_fullfeatured'));
        $this->assertFalse(component::is_deleted_plugin_type('fake'));
        $this->assertFalse(component::is_deleted_plugin('fake_fullfeatured'));
    ...
    public function test_core_component_deleted_plugintype(): void {
        ...
        $this->assertTrue(component::is_deleted_plugin('fake_fullfeatured'));
        $this->assertArrayNotHasKey('fake', component::get_deprecated_plugin_types());
        $this->assertArrayNotHasKey('fullfeatured', component::get_deprecated_plugin_list('fake'));
    ...
    public function test_core_component_deleted_subplugintype_supporting_subplugins(): void {
        ...
        // Debugging is expected to be emitted during core_component::init().
        $this->assert_deprecation_apis_subplugins();
        $this->assertDebuggingCalled('Deletion of a plugin type which supports subplugins is not supported. ' .
            'These plugin types will continue to be treated as active.', DEBUG_DEVELOPER);
    }
    ...
    protected function assert_deprecation_apis_subplugins(): void {
        ...
        $this->assertFalse(component::is_deprecated_plugin('fake_fullfeatured'));
        $this->assertFalse(component::is_deprecated_plugin('fullsubtype_example'));
        $this->assertTrue(component::is_deprecated_plugin('fulldeprecatedsubtype_test'));
        $this->assertFalse(component::is_deprecated_plugin('fulldeletedsubtype_demo'));
        ...
        $this->assertFalse(component::is_deleted_plugin('fake_fullfeatured'));
        $this->assertFalse(component::is_deleted_plugin('fullsubtype_example'));
        $this->assertFalse(component::is_deleted_plugin('fulldeprecatedsubtype_test'));
        $this->assertTrue(component::is_deleted_plugin('fulldeletedsubtype_demo'));
        ...
        $this->assertArrayNotHasKey('fullsubtype', component::get_deprecated_subplugins('fake_fullfeatured'));
        $this->assertArrayHasKey('fulldeprecatedsubtype', component::get_deprecated_subplugins('fake_fullfeatured'));
        $this->assertArrayNotHasKey('fulldeletedsubtype', component::get_deprecated_subplugins('fake_fullfeatured'));

        $this->assertArrayNotHasKey('fullsubtype', component::get_deleted_subplugins('fake_fullfeatured'));
        $this->assertArrayNotHasKey('fulldeprecatedsubtype', component::get_deleted_subplugins('fake_fullfeatured'));
        $this->assertArrayHasKey('fulldeletedsubtype', component::get_deleted_subplugins('fake_fullfeatured'));
